    ...
    <nav class="navbar navbar-expand-md bg-dark bg-opacity-50 py-3" data-bs-theme="dark" style="backdrop-filter: opacity(1);">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img id="logo" data-aos="zoom-in-up" data-aos-duration="600" data-aos-delay="300" src="assets/img/logo.png">
            </a>
    ...
    <div class="d-none d-md-block container-logout">
        <div class="container container-logout-content">
            <div class="font-monospace d-flex justify-content-between container-logout-values">
                <p class="font-monospace d-xl-flex" id="text-logout" style="height: auto;">Bem vindo, <?php echo $_SESSION['user']; ?>! você está logado em PAINEL - ADM</p><a id="btn-logout" class="btn btn-info d-xl-flex align-items-xl-center" role="button" href="logout.php">SAIR</a>
            </div>
        </div>
    </div>
    <main id="ctrl-panel">
        <div class="d-xl-flex justify-content-xl-center align-items-xl-center" id="redirecionamento">
                ...
                <div class="container redirecionamento-buttons">
                    <div class="row">
                        ...
                        <?php if ($statusUsuario == 8 || $statusUsuario == 10 || $statusUsuario == 11): ?>
                            <div class="col-md-4"><a class="btn btn-primary btn-panel" role="button" href="./setor-dp/deshboard-dp.php">Departamento Pessoal</a></div>
                        <?php else: ?>
    ...
    <footer class="bg-dark bg-opacity-50 py-4">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3">
                <div class="col">
                    <p class="text-secondary my-2" style="text-align: center;font-family: Poppins, sans-serif;font-size: 13px;">Copyright&nbsp;© 2024 São MIguel de Ilhéus</p>
                </div>
                <div class="col">
