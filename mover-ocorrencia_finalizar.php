...
if (isset($_POST['ocorrencia_id'])) {
    ...
    $query_move_ocorrencia = "INSERT INTO u219851065_smiguel.ocorrencia_finalizada SELECT * FROM u219851065_smiguel.ocorrencia_trafego WHERE id = $ocorrencia_id";
    ...
    if ($resultado_move) {
        ...
        $query_excluir_ocorrencia = "DELETE FROM u219851065_smiguel.ocorrencia_trafego WHERE id = $ocorrencia_id";
