...
$conn = new mysqli("localhost", "u219851065_admin", "Xavier364074$", "u219851065_smiguel");
...
$sql_graficos = "SELECT motorista, ocorrencia, acao FROM u219851065_smiguel.ocorrencia_finalizada";
...
$sql_motoristas = "SELECT motorista, COUNT(*) as total_ocorrencias 
                   FROM u219851065_smiguel.ocorrencia_finalizada 
                   GROUP BY motorista 
