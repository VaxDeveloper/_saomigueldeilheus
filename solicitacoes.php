        ...
        <div class="container position-relative">
            <div class="row mb-3">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h4>Tela de Contato e Solicitações</h4>
                    <p class="w-lg-30 d-none d-sm-block">Olá, bem vindo! fique a vontade para fazer a sua solicitação.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">victordeveloper74@gmail.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                ...
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" data-bss-recipient="0068a1811e45790730ec2eaec57cb0a5">
                            <div class="mb-3"><input class="form-control" type="text" id="name-1" placeholder="Name" name="name" required></div>
                            ...
                            <div class="d-flex"><a class="btn btn-info d-block w-50" role="button" href="painel.php">Voltar</a><button class="btn btn-primary d-block w-50" type="submit">Enviar</button></div>
                        </form>
                    </div>
                </div>
            </div>
