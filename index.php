...
if (!isset($_SESSION['user'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $dbHost = "localhost";
        $dbUser = "u219851065_admin";  // Substitua pelo seu usuário do banco de dados
        $dbPassword = "Xavier364074$";  // Substitua pela sua senha do banco de dados
        $dbName = "u219851065_smiguel";  // Substitua pelo nome correto do seu banco de dados
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>LOGIN</h2>
                    <p class="w-lg-50">Bem vindo a Transpoerte Urbano São MIguel de Ilhéus LTDA. Faça login para ter acesso ao painel e deshboards.</p>
                </div>
            </div>
