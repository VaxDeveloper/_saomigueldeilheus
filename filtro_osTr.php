...
<body>
    ...
    <div class="container">
        ...
        if (!isset($_SESSION['user']) || ($_SESSION['status'] != 2 && $_SESSION['status'] != 10)) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            if (isset($_GET['coluna']) && isset($_GET['filtro'])) {
                ...
                $consulta_sql = "SELECT * FROM u219851065_smiguel.ocorrencia_trafego WHERE $coluna LIKE '%$filtro%'";
            } else {
                // Caso contrário, consulta sem filtro
                $consulta_sql = "SELECT * FROM u219851065_smiguel.ocorrencia_trafego";
            }
